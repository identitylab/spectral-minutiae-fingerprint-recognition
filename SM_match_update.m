...
for j=1:100
    ...
    for k=1:100
        ...
        [ Y ] = templateSimilarity(Data, Data2 );
        
        
        FileName3=[num2str(j),BaseName1];
        jpegToSaveFileName = fullfile('C:\project source file\SpectralMinutia\data\spectra_20180418160546\',FileName3);% use path if you want to save to same directory
